...
@if (Session::has('cust_pr_edit_success'))
<div class="row">
            <div class="col m12">
                <div class="card-panel orange lighten-4 center-align red-text">
                    {{ Session::get('cust_pr_edit_success') }} <br>
...
{!! Form::open(['route'=>['edit_cust_person', $customer->id], 'class'=>'col s12']) !!}
<ul class="collapsible">
                            ...
                            <div class="col m12">                        
                                    <div class="row card-panel">                        
                                        <div class="input-field col s12 m12">                                
                                            {!! Form::text('name', $customer->name, ['length'=>30, 'id'=>'name']) !!}
                                    ...
                                    <div class="row card-panel">
                                            ...
                                            <div class="input-field col s12 m4">
                                                    {!! Form::text('father_name', $customer->father_name, ['length'=>30, 'id'=>'father_name']) !!}
                                                    {!! Form::label('father_name', '<i class="left material-icons">person</i> Fathers Name',[],false) !!}
                                            </div>
                                            <div class="input-field col s12 m4">
                                                    {!! Form::text('mother_name', $customer->mother_name, ['length'=>30, 'id'=>'mother_name']) !!}
                                                    {!! Form::label('mother_name', '<i class="left material-icons">person</i> Mothers Name',[],false) !!}
                                            </div>
                                            <div class="input-field col s12 m4">
                                                    {!! Form::text('spouse_name', $customer->spouse_name, ['length'=>30, 'id'=>'spouse_name']) !!}
                                    ...
                                    <div class="row card-panel">
                                            <div class="input-field col s12">                                                        
                                                {!! Form::textarea('present_address', $customer->present_address, ['class'=>'materialize-textarea', 'length'=>'120', 'id'=>'present_address']) !!}
                                    ...
                                    <div class="row card-panel">
                                        <div class="input-field col s12">
                                                {!! Form::textarea('perm_address', $customer->perm_address, ['class'=>'materialize-textarea', 'length'=>'120', 'id'=>'perm_address']) !!}
                                    ...
                                    <div class="row card-panel">
                                        <div class="input-field col s12 m4">
                                            ...
                                            {!! Form::text('mobile_1', $customer->mobile_1, ['id'=>'mobile_1', 'length'=>11]) !!}                                
                                            {!! Form::label('mobile_1', '<i class="left material-icons">local_phone</i> Mobile Number', [],false) !!}
                                            
                                        </div>
                                        <div class="input-field col s12 m4">
                                                {!! Form::text('mobile_2', $customer->mobile_2, ['id'=>'mobile_2', 'length'=>11]) !!}                                
                                                {!! Form::label('mobile_2', '<i class="left material-icons">local_phone</i> Mobile Number (Optional)', [],false) !!}
                                        </div>
                                        <div class="input-field col s12 m4">
                                                {!! Form::text('mobile_3', $customer->mobile_3, ['id'=>'mobile_3', 'length'=>11]) !!}                                
                                    ...
                                    <div class="row card-panel">
                                        ...
                                        <div class="input-field col m5 offset-m1">                        
                                            ...
                                            {!! Form::text('id_no', $customer->id_no, ['id'=>'id_no']) !!}
        ...
        <li  style="margin-top:5px;">
            ...
            <div class="collapsible-body   green lighten-2">
                <div class="row card-panel">
                    <div class="input-field col s12 m4">                                            
                        {!! Form::text('contact_name_1', $customer->contact_name_1, ['id'=>'contact_name_1', 'length'=>30]) !!}                                
                        {!! Form::label('contact_name_1', '<i class="left material-icons">person</i> Contact Person Name', [],false) !!} 
                    </div>
                    <div class="input-field col s12 m6">
                        {!! Form::text('contact_mobile_1', $customer->contact_mobile_1, ['id'=>'contact_mobile_1', 'length'=>11]) !!}                                
                        {!! Form::label('contact_mobile_1', '<i class="material-icons">local_phone</i> Contact Person Mobile Number (Optional)', [],false) !!}
                    </div>
                    <div class="input-field col s12 m12">                                                                                       
                        {!! Form::textarea('contact_address_1', $customer->contact_address_1, ['id'=>'contact_address_1', 'class'=>'materialize-textarea']) !!}                                
                ...
                <div class="row card-panel">
                        <div class="input-field col s12 m4">                                            
                            {!! Form::text('contact_name_2', $customer->contact_name_2, ['id'=>'contact_name_2', 'length'=>30]) !!}                                
                            {!! Form::label('contact_name_2', '<i class="left material-icons">person</i> Contact Person Name', [],false) !!} 
                        </div>
                        <div class="input-field col s12 m6">
                            {!! Form::text('contact_mobile_2', $customer->contact_mobile_2, ['id'=>'contact_mobile_2', 'length'=>11]) !!}                                
                            {!! Form::label('contact_mobile_2', '<i class="material-icons">local_phone</i> Contact Person Mobile Number (Optional)', [],false) !!}
                        </div>
                        <div class="input-field col s12 m12">                                                                                       
                            {!! Form::textarea('contact_address_2',$customer->contact_address_2, ['id'=>'contact_address_2', 'class'=>'materialize-textarea']) !!}                                
        ...
        <li>
            <div class="row">
                <div class="col m12 center-align" style="padding:10px;">
                    {!! Form::submit('Update Customer', ['class'=>'btn green']) !!} 
